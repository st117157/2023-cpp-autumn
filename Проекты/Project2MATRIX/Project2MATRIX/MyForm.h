...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Text = L"циферы считат";
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		// Собираем значения x в строку
		// Собираем все решения в одну строку
		String^ solutions = "";
		for (int l = 0; l < X; l++)
		{
		...
		// Присваиваем строку с решениями к label2->Text
		label1->Text = solutions;



		// Освобождаем память, выделенную для массива a и x
		for (int m = 0; m < X; m++) {
			delete[] a[m];
		}
		delete[] a;
